...
const TeacherDashboard = () => {
  ...
  return (
    <div className="sidebar-layout-root min-h-screen w-full relative">
      ...
      {/* ================= MOBILE SIDEBAR (fixed, clear and visible) ================= */}
      <AnimatePresence>
        {mobileMenuOpen && (
          <>
            ...
            >
              <div className="flex flex-col h-full p-4">
                ...
                <button
                  onClick={handleLogout}
                  className="w-full flex items-center gap-3 px-4 py-2 rounded-2xl transition-all bg-red-600 text-white hover:bg-red-700 border border-red-500/50 shadow-lg mt-5"
                  type="button"
                >
                  <LogOut size={20} />
