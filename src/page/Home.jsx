    ...
    <section className="w-full min-h-screen relative overflow-hidden ">
      <div className="w-full grid sm:grid-cols-2 sx:grid-cols-2 justify-center gap-6 px-4 md:px-16 py-8 my-6 glass rounded-lg">
        ...
        <div className="flex space-y-4 flex-col md:items-start sm:pt-[20%] pt-3 p-2 md:text-left ">
          ...
          <p className="font-medium lg:text-xl text-sm sx:hidden text-gray-700">
          ...
          <div className="flex space-x-4 pt-4 justify-start">
            <button className=" bg-orange-500 sm:py-4 sm:px-8 py-2 px-4 sm:rounded-lg rounded font-semibold shadow-md hover:shadow-lg transition-all hover:scale-105 duration-200 text-white cursor-pointer">
              Get Started
            </button>
            <button className=" text-gray-700 sm:py-4 sm:px-8 py-2 px-4 sm:rounded-lg rounded font-semibold shadow border-2 glass hover:shadow-lg transition-all hover:scale-105 duration-200 cursor-pointer">
              Learn More
            </button>
          </div>
      ...
      <section className="py-20 bg-muted glass">
        <div className=" text-gray-700 mx-auto px-6">
          <div className="text-center mb-16">
            ...
            <p className="sm:text-xl text-sm  max-w-3xl mx-auto text-pretty leading-relaxed">
            ...
            {milestone.achievements.map((achievement, index) => (
              <Card key={index} className="glass shadow-sm overflow-hidden hover:shadow-lg transition-shadow duration-300">
                ...
                <CardContent className="p-6">
                  <div className="sm:text-3xl text-xl font-semibold mb-2">{achievement.count}</div>
                  <h3 className="sm:text-xl text-sm font-semibold mb-3">{achievement.title}</h3>
                  <p className=" sm:text-xl text-sm leading-relaxed">{achievement.description}</p>
                </CardContent>
              </Card>
            ))}
          </div>
