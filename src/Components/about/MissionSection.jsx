...
export function MissionSection() {
  return (
    <section className="py-10 text-gray-700 rounded-lg relative overflow-hidden">
        ...
        <div className="text-center mb-16">
          ...
          <div className="max-w-4xl mx-auto">
            <p className="md:text-xl sm:text-sm text-xs mb-8 text-gray-600 leading-relaxed">
              At Excellence University, our mission is to advance knowledge
              through innovative research, provide transformative educational
              experiences, and prepare students to become ethical leaders who
              will make a positive impact on the world.
            </p>
          </div>
        </div>

        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-8 sm:p-20 ">
            ...
            >
              <Card className="glass shadow-2xl overflow-hidden hover:shadow-2xl transition-shadow duration-300 cursor-pointer">
                <CardContent className="p-1 text-center">
                  <div className="sm:text-5xl text-3xl mb-4">
                    {value.icon}
                  </div>
