...
export function CallToActionSection() {
  return (
    <section className="py-10 glass text-white text-primary-foreground">
      <div className=" flex flex-col gap-3 mx-auto text-center">
        <h2 className="text-lg md:text-2xl text-orange-600 font-bold">Ready to Join Our Community?</h2>
        ...
        <div>
          <Button className="px-6 p-20 sm:text-sm text-xs"
            onClick={() => {
