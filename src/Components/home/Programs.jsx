    ...
    >
      <div className="relative h-full flex flex-col overflow-hidden rounded-3xl backdrop-blur-2xl bg-gradient-to-br from-white/80 via-white/60 to-white/40 border-2 border-white/60 shadow-[0_20px_60px_rgba(0,0,0,0.15)] group hover:shadow-[0_30px_80px_rgba(139,92,246,0.4)] transition-all duration-500">
        ...
        <div className="relative flex-1 flex flex-col p-6 lg:p-7">
          ...
          <div className="mb-4">
            {/* Title */}
            <h3 className="text-xl lg:text-2xl font-bold mb-2 bg-gradient-to-r from-blue-600 via-purple-600 to-pink-600 bg-clip-text text-transparent">
              {department.name}
            </h3>
            ...
            {department.faculty && (
              <div className="flex items-center gap-2 text-sm">
                <div className="backdrop-blur-xl bg-gradient-to-r from-blue-500/20 to-purple-500/20 p-1.5 rounded-lg border border-white/50">
  ...
  return (
    <section className="py-20 my-4">
      <div className="mx-auto max-w-7xl px-4">
        ...
        >
          <div className="backdrop-blur-xl bg-white/50 px-6 py-3 rounded-full border-2 border-white/60 shadow-lg">
            <span className="text-sm font-medium text-gray-700">
              <span className="font-bold text-purple-600">{departments.length}</span> Department{departments.length !== 1 ? 's' : ''} Available
            </span>
          </div>
        </motion.div>
        ...
        >
          <div className="backdrop-blur-2xl bg-gradient-to-r from-blue-500/10 via-purple-500/10 to-pink-500/10 rounded-3xl p-10 border-2 border-white/50 shadow-xl max-w-3xl mx-auto">
